...
namespace RateLimiter
{
    public class RateLimiter
    {
        ...
        public bool TryMakeRequest(string username, string resource, Dictionary<string, string>? claims =null )
        {
            ...
            {
                if (!strategy.IsRequestAllowed(username, resource, _requestRepository))
                {
                    return false;
                }
            }

            _requestRepository.AddRequest(username, resource, DateTime.UtcNow, claims);
