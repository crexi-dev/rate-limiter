...
{
	public static class HistoryInspectorExtensions
	{
		/// <summary>
		...
		/// </summary>
		public static IHistoryInspector<T> And<T>(this IHistoryInspector<T> a, IHistoryInspector<T> b) =>
		...
		/// </summary>
		public static IHistoryInspector<T> Or<T>(this IHistoryInspector<T> a, IHistoryInspector<T> b) =>
			new HistoryInspectorBuilder<T>(history => a.IsRateLimited(history) || b.IsRateLimited(history));
		...
		public static IHistoryInspector<T> Inverse<T>(this IHistoryInspector<T> inspector) =>
